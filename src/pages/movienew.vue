    ...
    <div>
        ...
        <v-layout md8 justify-center>
            <v-flex md8 mt-3>
                ...
                <v-flex xs5 sm2>
                    <v-text-field label="Né(e) le" v-model="movie_to_add.realisator.birthdate"></v-text-field>
                </v-flex>
                <v-flex xs10 sm4>
                    <v-text-field label="Nationalité" v-model="movie_to_add.realisator.nationality"></v-text-field>
                </v-flex>
            </v-flex>  
        </v-layout>
